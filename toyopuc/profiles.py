...
class ToyopucAreaDescriptor:
    ...
    def get_ranges(
        self, prefixed: bool, packed: bool = False
        ...
        override = (
            self.packed_prefixed_ranges_override
            if prefixed
            else self.packed_direct_ranges_override
        )
    ...
    def get_ranges_for_unit(
        self, prefixed: bool, unit: str, packed: bool = False
    ) -> tuple[ToyopucAddressRange, ...]:
...
ToyopucAddressingOptions.Default = ToyopucAddressingOptions()  # type: ignore[attr-defined]
ToyopucAddressingOptions.Generic = ToyopucAddressingOptions()  # type: ignore[attr-defined]
ToyopucAddressingOptions.ToyopucPlusStandard = ToyopucAddressingOptions(  # type: ignore[attr-defined]
...
ToyopucAddressingOptions.ToyopucPlusExtended = ToyopucAddressingOptions.ToyopucPlusStandard  # type: ignore[attr-defined]
ToyopucAddressingOptions.Nano10GxMode = ToyopucAddressingOptions()  # type: ignore[attr-defined]
ToyopucAddressingOptions.Nano10GxCompatible = ToyopucAddressingOptions()  # type: ignore[attr-defined]
ToyopucAddressingOptions.Pc10GStandardPc3Jg = ToyopucAddressingOptions(  # type: ignore[attr-defined]
    use_upper_u_pc10=False,
    use_eb_pc10=True,
    use_fr_pc10=False,
    use_upper_bit_pc10=False,
...
ToyopucAddressingOptions.Pc10GMode = ToyopucAddressingOptions()  # type: ignore[attr-defined]
ToyopucAddressingOptions.Pc3JxPc3Separate = ToyopucAddressingOptions(  # type: ignore[attr-defined]
    use_upper_u_pc10=False,
    use_eb_pc10=False,
    use_fr_pc10=False,
    use_upper_bit_pc10=False,
...
ToyopucAddressingOptions.Pc3JxPlusExpansion = ToyopucAddressingOptions.Pc3JxPc3Separate  # type: ignore[attr-defined]
ToyopucAddressingOptions.Pc3JgMode = ToyopucAddressingOptions.Pc10GStandardPc3Jg  # type: ignore[attr-defined]
ToyopucAddressingOptions.Pc3JgPc3Separate = ToyopucAddressingOptions.Pc3JxPc3Separate  # type: ignore[attr-defined]
...
def _prefixed_split_bit_area(
    area: str, low_end: int, high_end: int
) -> ToyopucAreaDescriptor:
...
def _ext_bit_area(
    ...
    packed_override = (
        (_r(0x0000, packed_direct_end),) if packed_direct_end is not None else None
    )
    return _area(
        area,
...
class ToyopucDeviceProfiles:
    ...
    @classmethod
    def get_area_descriptor(
        cls, area: str, profile: str | None = None
    ) -> ToyopucAreaDescriptor:
...
ToyopucDeviceProfiles.Generic = ToyopucDeviceProfile(
    "Generic", _OPT.Generic, _generic_areas()  # type: ignore[attr-defined]
)
ToyopucDeviceProfiles.ToyopucPlusStandard = ToyopucDeviceProfile(
    "TOYOPUC-Plus:Plus Standard mode",
    _OPT.ToyopucPlusStandard,  # type: ignore[attr-defined]
