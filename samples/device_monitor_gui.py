...
class MonitorApp:
    ...
    def _build_ui(self):
        ...
        ttk.Label(connection_card, textvariable=self.endpoint_var, style="Value.TLabel").grid(
            row=1, column=0, sticky="w"
        )
        ttk.Label(connection_card, text="Connection", style="Meta.TLabel").grid(
            row=0, column=1, sticky="w", padx=(18, 0)
        )
        ttk.Label(connection_card, textvariable=self.connection_var, style="Value.TLabel").grid(
        ...
        ttk.Button(connect_row, text="Refresh Label", command=self._refresh_endpoint_preview).grid(
        ...
        ttk.Button(watch_card, text="Add", command=self._on_add, style="Accent.TButton").grid(
